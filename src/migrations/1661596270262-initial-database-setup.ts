...
export class initialDatabaseSetup1661596270262 implements MigrationInterface {
    name = 'initialDatabaseSetup1661596270262'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE "ride" ADD CONSTRAINT "FK_5aa9cf38a33da4d5e5a03df37b4" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        // await queryRunner.query(`ALTER TABLE "ride" ADD CONSTRAINT "FK_429a5ef74932a01f77431ce4610" FOREIGN KEY ("vehicle_id") REFERENCES "vehicle"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        // await queryRunner.query(`ALTER TABLE "user_vehicle" ADD CONSTRAINT "FK_3fdd13c107ab4081a6b70c38eac" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        // await queryRunner.query(`ALTER TABLE "user_vehicle" ADD CONSTRAINT "FK_fd8b89c8c46a7a0200d03045be7" FOREIGN KEY ("vehicle_id") REFERENCES "vehicle"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE "ride" DROP CONSTRAINT "FK_429a5ef74932a01f77431ce4610"`);
        // await queryRunner.query(`ALTER TABLE "ride" DROP CONSTRAINT "FK_5aa9cf38a33da4d5e5a03df37b4"`);
